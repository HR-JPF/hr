    ...
    <div className="w-full max-w-3xl mx-auto py-12 px-4 md:px-6" id="success-view">
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="p-6 md:p-8 space-y-8">
          ...
          {/* Interactive Scheduling Widget for Candidate (Display Only - Read Only if Scheduled by Admin) */}
          {!liveLoading && liveApplicant?.interviewSchedule && (
              ...
              <div className="border border-emerald-200 rounded-xl p-6 bg-emerald-50/50 space-y-4" id="scheduled-interview-card">
                <div className="flex items-center gap-3 border-b border-emerald-100 pb-4 mb-2 text-right justify-end flex-row-reverse">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-emerald-600 font-semibold">لقد تم جدولة وتأكيد موعد مقابلتك الشخصية الفنية بنجاح من قبل إدارة المصنع.</p>
                  </div>
                </div>
